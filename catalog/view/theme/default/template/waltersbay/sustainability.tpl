...
<div id="content">
    ...
    <ul class="text">
        <li> Education: Mandatory school attendance for all children. </li>
        <li> Day Care Centers: Provided for children before they reach school age. </li>
        <li> Housing: Subsidized housing for tea estate workers and their families.</li>
        <li> Healthcare: Free medical clinics for estate workers and their families. </li>
        <li> Retirement: Retirement programs provided for all workers. </li>
    </ul>
    <p class="para" align="center">
    ...
    <ul class="text">
        <li>
            <b> Hand-Plucking Tea Leaves: </b>
            <br>
            All of our tea leaves are hand-plucked in order to:
            <br>
            <ol>
                <li>Ensure tea quality.</li>
                <li>Eliminate carbon emissions from mechanized harvesters.</li>
                <li>Monitor and remove any imperfect leaves, as well as any harmful insects and pests.</li>
            </ol>
        </li>
        <br>
        <li>
            <b> Soil Maintenance: </b>
            <br>
            We maintain our soils by using grass varieties in our fields to control erosion.
        </li>
        <br>
        <li>
            <b> Limited-use of pesticides: </b>
            <br>
