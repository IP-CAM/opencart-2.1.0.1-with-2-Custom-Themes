...
<div class="container">
    <div class="row"><?php echo $column_left; ?>
		...
		<!-- BEGIN SLIDER -->
		<!--div class="container">
			<img class="" src="catalog/view/theme/waltersbay/image/slider_img.png" />
		</div-->
		<!-- END SLIDER -->
		...
		<div class="container">
			...
			<div class="row">
	            <div class="col-md-12 p-t-15">
	            	<p class="text-title">Select by Category</p>
	            </div>
			</div>
			<div class="row">
	            <div class="col-md-3">
			...
			<div class="row">
	            ...
	            <div class="col-md-1 p-t-15 text-right">
	            	<img alt="" src="catalog/view/theme/waltersbay/image/arrow-right-icon.png" />
	            </div>
			</div>
			...
			<div class="row text-center">
				<div class="col-md-12 m-t-50">
					...
					<form class="">
						...
						<div class="col-md-12">
							<button class="btn btn-md btn-default" action="">SIGN UP</button>
						</div>
					</form>
				</div>
			</div> 
